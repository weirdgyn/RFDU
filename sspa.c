 ...
 * 
 * La funzione di trasferimento del sensore Ë: T∞[C] = 159,65-[85,54*Vadc]
 * 
 ...
 * 
 * La funzione di trasferimento del sensore Ë: I[A] = 10*Vadc
 * 
 * @param Vadc valore acquisito
 ...
 * 
 * La funzione di trasferimento del sensore Ë: P[dBm] = 34+3,33*Vadc
 * 
 * @param Vadc valore acquisito
